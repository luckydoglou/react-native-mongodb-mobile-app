...
function SignupScreen(props) {
  ...
  // this function make sure props.signup() only be called once
  const signupHandler = () => {
    const signupData = {
      username: username,
      firstname: firstname,
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.TextInput} placeholder='Username' onChangeText={text => setUsername(text)} value={username} autoCapitalize='none' />
      ...
      <TextInput style={styles.TextInput} placeholder='Password' secureTextEntry={true} onChangeText={text => setPassword(text)} value={password} autoCapitalize='none' />
